...
pacman -Sy --noconfirm xorg-server xorg-xrandr xorg-xinit libxinerama bash rustup nushell networkmanager unzip pipewire pipewire-pulse man-db intel-ucode amd-ucode ntfs-3g git neovim p7zip unrar alacritty
